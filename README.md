...
An additional 10 solutions were submitted either after the deadline or by Hola employees, and we considered them hors concours (off-contest). These are found in the `extra` directory.
...
92 programs, or 39% of all participating solutions, passed our correctness tests. Also, 6 of the solutions considered hors concours passed.
